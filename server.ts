...
import b2bHandler from "./api/admin/b2b";
...
async function startServer() {
  ...
  // 1.2 B2B Prospecting: Unified handler (search | invite | convert)
  app.post("/api/admin/b2b", async (req: Request, res: Response) => {
    await b2bHandler(req as any, res as any);
  });
